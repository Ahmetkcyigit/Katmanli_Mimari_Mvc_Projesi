...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator : AbstractValidator<Writer>
    {
        ...
        {
            RuleFor(x => x.WriterName).NotEmpty().WithMessage("Burayı boş geçemezsiniz.");
            RuleFor(x => x.WriterSurname).NotEmpty().WithMessage("Burayı boş geçemezsiniz");
            RuleFor(x => x.WriterAbout).NotEmpty().WithMessage("Burayı boş geçemezsiniz");
            ...
            RuleFor(x => x.WriterTitle).NotEmpty().WithMessage("Burayı boş geçemezsiniz");
        }
    }
}
